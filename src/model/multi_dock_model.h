...
constexpr int kDefaultBounceCount = 3;
constexpr int kDefaultZoomingAnimationSpeed = 16;
constexpr bool kDefaultIndicatorGlow = false;
constexpr bool kDefaultIndicatorGlowActiveOnly = false;
constexpr int kDefaultIndicatorGlowIntensity = 50;
constexpr bool kDefaultAnimatedIndicator = false;
...
class MultiDockModel : public QObject {
 ...
 public:
  ...
  int bounceCount() const {
    return appearanceProperty(kGeneralCategory, kBounceCount,
                              kDefaultBounceCount);
  }

  void setBounceCount(int value) {
    setAppearanceProperty(kGeneralCategory, kBounceCount, value);
  }

  bool indicatorGlow() const {
    return appearanceProperty(kGeneralCategory, kIndicatorGlow,
                              kDefaultIndicatorGlow);
  }

  void setIndicatorGlow(bool value) {
    setAppearanceProperty(kGeneralCategory, kIndicatorGlow, value);
  }

  bool indicatorGlowActiveOnly() const {
    return appearanceProperty(kGeneralCategory, kIndicatorGlowActiveOnly,
                              kDefaultIndicatorGlowActiveOnly);
  }

  void setIndicatorGlowActiveOnly(bool value) {
    setAppearanceProperty(kGeneralCategory, kIndicatorGlowActiveOnly, value);
  }

  int indicatorGlowIntensity() const {
    return appearanceProperty(kGeneralCategory, kIndicatorGlowIntensity,
                              kDefaultIndicatorGlowIntensity);
  }

  void setIndicatorGlowIntensity(int value) {
    setAppearanceProperty(kGeneralCategory, kIndicatorGlowIntensity, value);
  }

  bool animatedIndicator() const {
    return appearanceProperty(kGeneralCategory, kAnimatedIndicator,
                              kDefaultAnimatedIndicator);
  }

  void setAnimatedIndicator(bool value) {
    setAppearanceProperty(kGeneralCategory, kAnimatedIndicator, value);
  }
 ...
 private:
  ...
  static constexpr char kBounceCount[] = "bounceCount";
  static constexpr char kZoomingAnimationSpeed[] = "zoomingAnimationSpeed";
  static constexpr char kIndicatorGlow[] = "indicatorGlow";
  static constexpr char kIndicatorGlowActiveOnly[] = "indicatorGlowActiveOnly";
  static constexpr char kIndicatorGlowIntensity[] = "indicatorGlowIntensity";
  static constexpr char kAnimatedIndicator[] = "animatedIndicator";
