...
void AppearanceSettingsDialog::loadData() {
  ...
  ui->animatedIndicator->setChecked(model_->animatedIndicator());
}
...
void AppearanceSettingsDialog::resetData() {
  ...
  ui->animatedIndicator->setChecked(kDefaultAnimatedIndicator);
}
...
void AppearanceSettingsDialog::saveData() {
  ...
  model_->setAnimatedIndicator(ui->animatedIndicator->isChecked());
